...
Follow this [GUIDE](https://pub.dartlang.org/packages/scrumlab_flutter_masked_text#-installing-tab-)
...
```dart
import 'package:scrumlab_flutter_masked_text/scrumlab_flutter_masked_text.dart';
```
...
You can check some code samples in this repo: [scrumlab-scrumlab-flutter-masked-text-samples](https://github.com/scrum-lab/scrumlab-scrumlab-flutter-masked-text-samples)
